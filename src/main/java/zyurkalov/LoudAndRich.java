...
//        integer array quiet where quiet[i] is the quietness of the ith person.
    ...
    public static void main(String[] args) {
        ...
        var output = Arrays.toString(new LoudAndRich().loudAndRich(
                ...
                new int[]{17,33,29,39,41,10,1,19,5,8,18,15,7,25,45,48,35,28,34,22,31,36,27,47,42,43,14,49,20,9,16,40,44,32,13,24,4,21,30,11,0,46,38,2,12,6,37,23,3,26}
        ));
